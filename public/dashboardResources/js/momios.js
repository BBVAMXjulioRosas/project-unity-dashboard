...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
	...
	var Momios = require('./momios/momiosTablas.js');
	
	var momios= new Momios();
	},{"./momios/momiosTablas.js":2,"jquery":19}],2:[function(require,module,exports){
	var Servicios = require('../registro/servicios');
	var SelectComponent = require('../registro/selectComponent');
	var Button = require('../sospechosos/button');
	...
	var Momios = function () {
		...
		document.getElementById('diabetes').addEventListener('click', this.eventosTablas.bind(this))
		document.getElementById('hiperten').addEventListener('click', this.eventosTablas.bind(this))
		document.getElementById('obesidad').addEventListener('click', this.eventosTablas.bind(this))
		document.getElementById('defensas').addEventListener('click', this.eventosTablas.bind(this))
	}
	
	//Funciones Generales 
	
	//Funcion que renicia los filtros que se hayan modificado en una interacción anterior
	Momios.prototype.refreshFilters = function () {
	...
	Momios.prototype.setFechaActual = function () {
	...
	Momios.prototype.fechaPasada = function () {
	...
	Momios.prototype.fechaSemana = function(fechaActual) {
	...
	Momios.prototype.fechaUnMes = function (fechaActual) {
		let date = new Date(); //Fecha actual
	...
	Momios.prototype.fechaAmilisegundos = function (date) {
	...
	Momios.prototype.formatearFecha = function (date) {
	...
	Momios.prototype.formatoFechaInputs = function (date) {
	...
	Momios.prototype.eventosEstados = function () {
		this.filtros.municipio = undefined;
		this.filtros.colonia = undefined;
		...
		if (this.estados.element.value !== "all") {
			...
			this.servicios.getMomios(this.filtros, 'diabetes').then((data)=>{
				this.setDiabetesTable(data)
			})
		
			this.servicios.getMomios(this.filtros, 'obesity').then((data)=>{
				this.setObesidadTable(data)
			})
		
			this.servicios.getMomios(this.filtros, 'hypertension').then((data)=>{
				this.setHipertensionTabe(data)
			})
		
			this.servicios.getMomios(this.filtros, 'defenses').then((data)=>{
				this.setDefensasTable(data)
			})
	...
	Momios.prototype.eventosMunicipios = function () {
		this.filtros.colonia = undefined;
	...
	Momios.prototype.eventosColonias = function () {
	...
	Momios.prototype.setTemporalidad = function (event) {
	...
	Momios.prototype.filtroPorFecha = function (value){
	...
	Momios.prototype.getEstados = function () {
		this.servicios.getStates().then((data) => {
			this.fillEstados(data);
		});
	}
	
	Momios.prototype.getMunicipios = function () {
	...
	Momios.prototype.getColonias = function () {
	...
	Momios.prototype.fillEstados = function (collection) {
		this.estados.fill(collection);
	}
	
	//Llena el Select de Delegaciones Municipios
	Momios.prototype.fillMunicipios = function (collection) {
		this.municipios.fill(collection)
	}
	
	//Llena el Select de Colonias Asentamientos
	Momios.prototype.fillColonias = function (collection) {
		this.colonias.fill(collection)
	}
	
	Momios.prototype.fillGenero = function (collection) {
		this.genero.fillGeneral(this.generoFilter);
	}
	
	Momios.prototype.setDiabetesTable = function (data) {
		$("#orDiabetes").text(data.or)
		$("#minDiabetes").text(data.ic.low)
		$("#maxDiabetes").text(data.ic.high)
		$("#expuestosDiabetes").text(data.cases.exposed)
		$("#expuestosDiabetesPorcentaje").text(data.controls.exposed)
		$("#noExpuestosDiabetes").text(data.cases.noExposed)
		$("#noExpuestosDiabetesPorcentaje").text(data.controls.noExposed)
	}
	
	Momios.prototype.setHipertensionTabe = function (data) {
		$("#orHiper").text(data.or)
		$("#minHiper").text(data.ic.low)
		$("#maxHiper").text(data.ic.high)
		$("#expuestosHiper").text(data.cases.exposed)
		$("#expuestosHiperPorcentaje").text(data.controls.exposed)
		$("#noExpuestosHiper").text(data.cases.noExposed)
		$("#noExpuestosHiperPorcentaje").text(data.controls.noExposed)
	}
	
	Momios.prototype.setObesidadTable = function (data) {
		$("#orObesi").text(data.or)
		$("#minObesi").text(data.ic.low)
		$("#maxObesi").text(data.ic.high)
		$("#expuestosObesi").text(data.cases.exposed)
		$("#expuestosObesiPorcentaje").text(data.controls.exposed)
		$("#noExpuestosObesi").text(data.cases.noExposed)
		$("#noExpuestosObesiPorcentaje").text(data.controls.noExposed)
	}
	
	Momios.prototype.setDefensasTable = function (data) {
		$("#orDefen").text(data.or)
		$("#minDefen").text(data.ic.low)
		$("#maxDefen").text(data.ic.high)
		$("#expuestosDefen").text(data.cases.exposed)
		$("#expuestosDefenPorcentaje").text(data.controls.exposed)
		$("#noExpuestosDefen").text(data.cases.noExposed)
		$("#noExpuestosDefenPorcentaje").text(data.controls.noExposed)
	}
	
	Momios.prototype.cleanTables = function (){
		$("#expuestosDiabetes").text(0)
		$("#expuestosDiabetesPorcentaje").text(0)
		$("#noExpuestosDiabetes").text(0)
		$("#noExpuestosDiabetesPorcentaje").text(0)
		$("#expuestosHiper").text(0)
		$("#expuestosHiperPorcentaje").text(0)
		$("#noExpuestosHiper").text(0)
		$("#noExpuestosHiperPorcentaje").text(0)
		$("#expuestosObesi").text(0)
		$("#expuestosObesiPorcentaje").text(0)
		$("#noExpuestosObesi").text(0)
		$("#noExpuestosObesiPorcentaje").text(0)
		$("#expuestosDefen").text(0)
		$("#expuestosDefenPorcentaje").text(0)
		$("#noExpuestosDefen").text(0)
		$("#noExpuestosDefenPorcentaje").text(0)
	}
	
	//Eventos Tablas
	Momios.prototype.eventosTablas = function (event) {
	...
	module.exports = Momios
	},{"../registro/selectComponent":3,"../registro/servicios":4,"../sospechosos/button":5,"bootstrap":6}],3:[function(require,module,exports){
